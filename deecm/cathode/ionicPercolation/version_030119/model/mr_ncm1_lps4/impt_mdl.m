...
% ncm.sgm     = ncm.ave / ncm.ave(1) * 0.5;   % The deviation of NMC particles, reference to 5um-NMC
ncm.sgm     = [0.5,2,3];
ncm.min     = [4.2, 7.8, 10];
ncm.max     = [6.1, 14.8, 18];
...
lps.ave     = [0.4,0.8,1.2,2.0,3.0,5,8,12,15];   % The designed average diameter of all LPS, in unit um
lps.min     = lps.ave / lps.ave(4) * 1.4;       % The minimum diameter of LPS particles, reference to 1.5um-LPS
lps.max     = lps.ave / lps.ave(4) * 3.4;        % The maximum diameter of LPS particles, reference to 1.5um-LPS
