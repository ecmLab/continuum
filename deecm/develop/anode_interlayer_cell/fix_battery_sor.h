...
class FixBatterySOR : public Fix {
 ...
 protected:
  ...
  double sigma_el_SE;           // Electrolyte conductivity (SE) (S/m)
  double sigma_el_CB;           // Electrolyte conductivity (CB) (S/m)
  double sigma_ed_LI;           // Electronic conductivity for Li (S/m)
