...
class FixRadiusExpansion : public Fix {
 ...
 protected:
  ...
  double Omega_Si;           // Molar volume of Si (10.96e-6 m³/mol)
  double Omega_Li_eff;       // Effective molar volume of Li in Si (9e-6 m³/mol)
  ...
  double *silicon_content;      // Moles of silicon (from lithium_diffusion)
