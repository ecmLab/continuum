...
%% 2.Define properties of conductive carbon particles
% Assuming uniform particle size for carbon, 0.1 um
carbon         = struct;
carbon.den     = 2.2;           % Carbon density, pg/μm^3 (equivalent to g/cm^3), based on the paper:
                                % https://www.sciencedirect.com/science/article/pii/S2542435121005316
carbon.typ     = 2;             % Label carbon particles as Type 2 particles
carbon.dia     = 0.1;           % Designed diameter of carbon particles, μm

%carbon.nD      = 1;             % The number of sampling diameters of carbon particles
carbon.ave     = carbon.dia;           % Designed diameter of carbon particles, μm
%carbon.min     = 0.1;           % Minimum carbon diameter
%carbon.max     = 0.1;           % Maximum carbon diameter
%carbon.sgm     = 0.1;           % Deviation of carbon particles
...
%carbon = cmp_prob(carbon,carbon.nD,1);  % For carbon particles
