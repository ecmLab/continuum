...
%carbon = cmp_nmbr(carbon,carbon.vol);% For carbon particles

% Uniform carbon size distribution
carbon.nTot      = round(6/pi*carbon.vol/carbon.dia^3);                  % Approximate total number of particles
carbon.rVol      = carbon.nTot * pi/6*carbon.dia^3;                      % Real volume of total particles
