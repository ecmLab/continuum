...
for line in lines:
    ...
    if type_index == 2:
        ...
        Carb_lst.append(coord)
    elif bool and type_index == 4:
        SYS_thk = particle_data[4] - particle_data[5]
        bool = False

num_NMC = len(NMC_lst)
num_LPS = len(LPS_lst)
num_Carb = len(Carb_lst)
...
Carb_tmp1  = np.asarray(Carb_lst)
Carb_tmp2  = Carb_tmp1[Carb_tmp1[:,0].argsort()]
Carb_array = Carb_tmp2[:,2:]
