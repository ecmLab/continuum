...
par.nLps    = 6;                     % Number of totoal LPS sizes
par.iSty    = 2;                     % Study types: 1 means box size study, 2 means loading study, 3 means massratio study
...
elseif par.iSty == 2
   ...
   par.ncmMr = 81;                   % Mass ratio of NCM of current study
   par.prsty = 0.6;                  % Designed initial porosity for current study   
elseif par.iSty == 3 
...
% 2. Generate models of different LPS sizes of current mass ratio and current NMC particles
    for isz = 5 : 5
        ...
        rst.num(imdl,isz) = sum(ncm.sz.nDia) + sum(lps.sz.nDia);           % Sotre total number of particles
