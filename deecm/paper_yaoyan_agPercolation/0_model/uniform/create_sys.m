...
sys.lx      = 20;                                              % The box size in x direction, in unit um; 20 is for plot; 2 is for calculation
sys.ly      = 20;                                              % The box size in y direction, in unit um; 20 is for plot; 2 is for calculation
