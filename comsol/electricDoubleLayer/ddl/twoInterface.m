% twoInterface.m
% Two-interface diffuse double layer model - Asymmetric Configuration
...
fprintf('Building TWO-INTERFACE model (asymmetric: V + ground)...\n');
fprintf('Configuration: Left at V with Stern, Right grounded with Stern\n\n');
...
% Set parameters - ASYMMETRIC TWO INTERFACE CONFIGURATION
...
model.param.set('phiM_L', '10[mV]', 'Left electrode potential (applied voltage)');
model.param.set('phiM_R', '0[mV]', 'Right electrode potential (grounded metal)');
