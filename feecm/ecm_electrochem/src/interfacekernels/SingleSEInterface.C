...
registerMooseObject("ecmElectrochemApp", SingleSEInterface);
...
SingleSEInterface::SingleSEInterface(const InputParameters & parameters)
...
ADReal
SingleSEInterface::computeQpResidual(Moose::DGResidualType type)
{
  ADReal r = 0;
