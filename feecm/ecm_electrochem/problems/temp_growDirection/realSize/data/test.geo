...
// Parameters 
xSE   = 500.0;  // length of the SE, in unit um
ySE   = 200.0;  //height of the SE, in unit um
xLi   = 50;    // length of the Li, in unit um
yLi   = 2;   //height of the Li, in unit um
rp    = 0.1;  // the round radius at corner point, in unit um

m1    = 10.0; // mesh characteristic length for boundary points
m2    = 1.0; // mesh characteristic length for interface points
m3    = 1.0; // mesh characteristic length for inner points

//**** Create points **/
Point(1) = {0, 0, 0, m3};     Point(2) = {xSE, 0, 0, m1};
...
Curve Loop(12)  = {4, 5, 6, 7, 8, 9, -10};   // Li boundary
