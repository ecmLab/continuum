...
[BCs]
  ...
  #   type = PorousFlowSink
  #   variable = porepressure
  #   flux_function = "if (t <= 500,if (t <10, -66.41344e-9*1.0*t,-66.41344e-9*10), 66.41344e-9)"
...
[Materials]
  ...
  [thermal_contribution]
    ...
    temperature = temperature
    thermal_expansion_coeff = 0.0 # this is the linear thermal expansion coefficient
