...
[Mesh]
  ...
  [./mesh]
    ...
    file = 'data/test_w_pore_interlayer_w_block_h0.52.e'
...
[BCs]
  ...
  [./uy]
    type = ADDirichletBC
    preset = true
    boundary = 'blockCeramic_bottom blockPore_top'
    variable = uy
    value = 0
  [../]
  # [./pressure]
...
[Problem]
  ...
  group_variables = 'V flux_interlayer li_conc; ux uy  normal_lm_x_pore normal_lm_y_pore interlayer_pore_normal_lm normal_lm_y_anode normal_lm_x_anode'
