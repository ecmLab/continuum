...
#include "ionicSELiBV.h"

registerADMooseObject("ecBetaApp", ionicSELiBV);

InputParameters
ionicSELiBV::validParams()
{
...
ionicSELiBV::ionicSELiBV(const InputParameters & parameters)
