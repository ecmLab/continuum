...
INSMomentumGravity::INSMomentumGravity(const InputParameters & parameters) :
  Kernel(parameters),
...
Real INSMomentumGravity::computeQpResidual()
{
...
Real INSMomentumGravity::computeQpJacobian()
{
...
Real INSMomentumGravity::computeQpOffDiagJacobian(unsigned jvar)
{
