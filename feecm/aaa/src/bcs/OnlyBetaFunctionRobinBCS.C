...
OnlyBetaFunctionRobinBCS::OnlyBetaFunctionRobinBCS(const InputParameters & parameters) :
...
Real
OnlyBetaFunctionRobinBCS::computeQpResidual()
{
  return -_test[_i][_qp]*_alpha*(_func.value(_t, _q_point[_qp]) -_u[_qp]);
}

Real
OnlyBetaFunctionRobinBCS::computeQpJacobian()
{
