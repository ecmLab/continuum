...
InputParameters validParams<ThermalGradient>()
{
  ...
  params.addRequiredParam<MooseEnum>("component", component, "The desired component of thermal_gradient.");
...
ThermalGradient::ThermalGradient(const InputParameters & parameters) :
...
ThermalGradient::computeValue()
{
  ...
  return - _T_gradient[_qp](_component);
}
