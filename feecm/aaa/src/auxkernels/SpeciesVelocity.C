...
InputParameters validParams<SpeciesVelocity>()
{
  ...
  params.addRequiredCoupledVar("ocular_pressure", "The pressure field.");

  return params;
}

SpeciesVelocity::SpeciesVelocity(const InputParameters & parameters) :
