...
InputParameters validParams<VoltPFParamsPolyFreeEnergy>()
{
  ...
  params.addCoupledVar("volt", "voltage variable in V");
...
void
VoltPFParamsPolyFreeEnergy::computeQpProperties()
{
  ...
  switch (_order)
  {
    ...
    case 2: //Eigth order
      ...
      break;
    default:
      mooseError("Error in VoltPFParamsPolyFreeEnergy: incorrect polynomial order");
  }
