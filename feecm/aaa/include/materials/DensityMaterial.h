...
#ifndef DENSITYMATERIAL_H
#define DENSITYMATERIAL_H
 ...
 */
class DensityMaterial : public Material
{
public:
  DensityMaterial(const InputParameters & parameters);
