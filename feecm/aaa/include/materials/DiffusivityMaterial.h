...
#ifndef DIFFUSIVITYMATERIAL_H
#define DIFFUSIVITYMATERIAL_H

#include "Material.h"
#include "LinearInterpolation.h"

//Forward Declarations
class DiffusivityMaterial;
 ...
 */
class DiffusivityMaterial : public Material
{
public:
  DiffusivityMaterial(const InputParameters & parameters);
