...
#ifndef RATECONSTANTMATERIAL_H
#define RATECONSTANTMATERIAL_H

#include "Material.h"
#include "LinearInterpolation.h"

//Forward Declarations
class RateConstantMaterial;
 ...
 */
class RateConstantMaterial : public Material
{
public:
  RateConstantMaterial(const InputParameters & parameters);
