...
#ifndef TEMPERATUREDEPENDENTMATERIAL_H
#define TEMPERATUREDEPENDENTMATERIAL_H
 ...
 */
class TemperatureDependentMaterial : public Material
{
public:
  TemperatureDependentMaterial(const InputParameters & parameters);
...
#endif //TEMPERATUREDEPENDENTMATERIAL_H
