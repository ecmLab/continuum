...
#ifndef THERMALCONDUCTIVITYMATERIAL_H
#define THERMALCONDUCTIVITYMATERIAL_H

#include "Material.h"
#include "LinearInterpolation.h"

//Forward Declarations
class ThermalConductivityMaterial;
 ...
 */
class ThermalConductivityMaterial : public Material
{
public:
  ThermalConductivityMaterial(const InputParameters & parameters);
...
#endif //THERMALCONDUCTIVITYMATERIAL_H
