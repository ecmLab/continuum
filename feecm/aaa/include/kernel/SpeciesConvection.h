...
#ifndef SPECIESCONVECTION_H
#define SPECIESCONVECTION_H

#include "Kernel.h"

// Forward Declaration
class SpeciesConvection;
 ...
 * equation.
 */
class SpeciesConvection : public Kernel
{
public:
  SpeciesConvection(const InputParameters & parameters);
