...
[Mesh]
  ...
  ny = 5 #10 #20 #25
  nz = 5 #10 #20 #25
  xmax = 50.000 #4.50e2 #Length of the solder material
  ymax = 50.000 #0.100 #4.50e2 #height of the solder material
  zmax = 50.000 #0.100  #9.00e5 #thickness of the solder material
[]
...
#active = 'HeatDiff'
  ...
  #[./HeatSink]
    #type = HeatSource
    #variable = T
    #value= '-1.74e-7'  #rho*cp*T-dot in J/ms
    #function = heat_sink
    #block = '0' 
  #[../]
[]
...
[./heat_sink]
    ...
    vars = 'k'
    vals = '6.0e5 1.82e6'  #these are in SI units
    vals = '-2.857e-4'  # C/(ms mm^2) and 1/{mho mm)
[../]
...
[./amb_T]
    ...
    #vals = '583 9.08e-5'  # K and K/ms
    #vals = '574.5 8.36e-5'  # K and K/ms
    vals = '574.5 4.18e-5'  # K and K/ms
[../]
#[./h_conv]
    #type = ParsedFunction
    #value = 'a*t^(-m)' # a in J/(ms mm^2 K) and m with base t is dimensionless
...
[BCs]
  ...
  [../]
   [./robin_boundaries3]
    ...
    boundary = 'top '
    betafunction = 'amb_T'
    alpha =  0.0 #15e-9 #15 #convection heat transfer coefficient in J/(ms mm^2 K)
    #beta = 298 #440.5  # T_coolant in K
  [../]
   # [./robin_boundaries2]
