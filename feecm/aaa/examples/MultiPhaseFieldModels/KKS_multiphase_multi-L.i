...
[Materials]
  ...
  f_name = L1
  args = 'eta1 eta2 eta3'
  constant_names =       '   a1   a2    a3 '
  constant_expressions = '   1    1     1  '
  function = '(eta1^3*(6*eta1^2-10*eta1))*(1.0/a1)+(eta2^3*(6*eta2^2-10*eta2))*(1.0/a2)+(eta3^3*(6*eta3^2-10*eta3))*(1.0/a3)'
  derivative_order = 0
  outputs = exodus
  output_properties = 'L1'
  [../]
  ...
  args = 'eta1 eta2 eta3'
  constant_names =       '   a1   a2    a3 '
  constant_expressions = '   2    2     2  '
  function = '(eta1^3*(6*eta1^2-10*eta1+15))*(1.0/a1)+(eta2^3*(6*eta2^2-10*eta2+15))*(1.0/a2)+(eta3^3*(6*eta3^2-10*eta3+15))*(1.0/a3)'
  derivative_order = 0
  outputs = exodus
  output_properties = 'L2'
  [../]
[]
