...
[Problem]
  restart_file_base = 'CC_charging_I_${I}_negative_cp/LATEST'
...
[Functions]
  ...
  # [in]
  #   type = PiecewiseLinear
  #   x = '0  ${t0}  ${t1}'  # Time points: start, ramp_end, simulation_end
...
[Outputs]
  file_base = 'CV_charging_I_${I}_negative'
  csv = true
  exodus = true
