...
if strcmp(str,'smth50')
    xSE   = 50;      % length of the SE, in unit um
    ySE   = 50;      % height of the SE, in unit um
elseif strcmp(str,'smthLL')
    xSE   = 1;      % length of the SE, in unit um
    ySE   = 1;      % height of the SE, in unit um    
else
...
elseif strcmp(str,'smthW')
    yLi   = 0.01;   % height of the Li, in unit um
else
    yLi   = 0.005;  % height of the Li, in unit um
end
if strcmp(str,'smth50')
    rp    = 0.01;   % The round radius
else
    rp    = 0.05;   % The round radius
end
