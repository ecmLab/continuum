...
[AuxKernels]
  ...
  [../]
  [./bndliflux]
    type = AnisoDiffusionFluxNormalToBoundary
    variable = bndliflux
...
[Functions]
  [./uy]
    type = ParsedFunction
    value = 'if (t > 0.1, 1e-3 + -1.0e-3*t*x, 0)'
    # value = '0.0'
  ...
  [./flux]
    type = ParsedFunction
    # value = 'if (t > 1.0, 1e-3, 0.0)'
    value = 'if (t> 0.1, 1e-4, 0.0)'
    # value = '1e-4'
  [../]
  [./gapk]
    type = PiecewiseLinear
...
[Problem]
  ...
  group_variables = 'ux uy mech_contact_normal_lm; li_ion_V li_metal_conc thermal_lm mu_sigma'
