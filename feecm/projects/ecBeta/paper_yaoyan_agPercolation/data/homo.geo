...
dw   = 0.01;       //width of the Ag network at the middle, in unit um

m0BL  = 0.2;     // mesh characteristic length for the bl miec
m1Pr  = 0.02;    // mesh characteristic length for Ag particles or pores
...
//*** Create Ag percolating line **/
Point(10)   = {-dw/2, -ly/2+0.1,   0, m1Pr};
Point(11)   = { dw/2, -ly/2+0.1,   0, m1Pr};
Point(12)   = { dw/2,  ly/2-0.1,  0, m1Pr};
Point(13)   = {-dw/2,  ly/2-0.1,  0, m1Pr};
Point(14)   = { 0, -ly/2+0.1,   0, m1Pr};
Point(15)   = { 0,  ly/2-0.1,   0, m1Pr};
Circle(9)   = {10,14,11};
Line(10)    = {11,12};
Circle(11)  = {12,15,13};
Line(12)    = {13,10};
...
//*** Create blocks for the BL*/
//Plane Surface(1) = {51,52,53};
Plane Surface(1) = {51,53};
