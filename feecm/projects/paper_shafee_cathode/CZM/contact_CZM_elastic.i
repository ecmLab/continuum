...
[Materials]
  ...
  [./czm_elastic_incremental]
    ...
    boundary = 'block_NMC_block_LPS'
    # These stiffness parameters act similarly to a penalty factor to enforce
    # cohesion before failure. You can adjust these to fit your material behavior.
    normal_stiffness = 1e5
    tangent_stiffness = 1e5
  [../]
[]
...
[Outputs]
  exodus = true
  file_base = rst/ystr${ystr}_E${ymod}_spTop${sptop}_CZM
  [./csv]
    type = CSV
    execute_on = 'final'
  [../]
