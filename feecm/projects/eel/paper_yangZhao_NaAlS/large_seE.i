## When SE Young's modulus is 1.53e3 for NAlS, it is too high for convergence
#  due to the large contract with the anode
#  Special debugging treatment in this input file is designed for this purpose
...
dt = '${fparse t0/1000}'      # Inital time step, to be adapted in TimeStepper, in s
endT = '${fparse t0*3600}'
...
#  line_search = bt   #this works good for large E contract but fore small contract
  line_search = none
...
[Outputs]
  file_base = rst/oneDefect1um_oneSE_E10
  [exodus]
    type = Exodus
  []
  [csv]
