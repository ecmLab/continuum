## For defect depth comparison, only change input models but keep others the same
# mode name is oneDefect1um_oneSE or oneDefect2um_oneSE
mdName = 'oneDefect2um_oneSE'
