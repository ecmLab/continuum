...
#SBATCH -A mat250014p
#SBATCH --output=logs_ced5/job_%A_%a.out
#SBATCH --error=logs_ced5/job_%A_%a.err
...
#
# How to run:
#   Make sure to run "mkdir -p logs_ced5 runs_ced5"
#   sbatch 2_sweep.sh
