[Mesh]
  ...
  [./primary_block1]
    ...
    new_block_name = 'mech_contact_primary_subdomain1'
  [../]
  [./secondary_block1]
    type = LowerDBlockFromSidesetGenerator
    input = primary_block1
    sidesets = 'interLayer_top'
    new_block_name = 'mech_contact_sec_subdomain1'
  [../]

  [./top_node]
    type = BoundingBoxNodeSetGenerator
    input = secondary_block1
    top_right = '0.1 12.49 0'
    bottom_left = '-0.01 12.51 0'
...
[Variables]
  ...
  [./thermal_lm1]
    block = 'mech_contact_sec_subdomain1'
  [../]
...
[AuxVariables]
  ...
  [./li_blockMetal_flux_x]
    order = CONSTANT
    family = MONOMIAL
    block = 'blockCeramic interLayer blockMetal'
  [../]
  [./li_blockMetal_flux_y]
    order = CONSTANT
    family = MONOMIAL
    block = 'blockCeramic interLayer blockMetal'
  [../]
  [./li_blockMetal_flux_z]
    order = CONSTANT
    family = MONOMIAL
    block = 'blockCeramic interLayer blockMetal '
  [../]
...
[Problem]
  ...
  group_variables = 'ux uy normal_lm_x normal_lm_y normal_lm_x1 normal_lm_y1; li_ion_V thermal_lm thermal_lm1 li_metal_conc'
...
[Constraints]
  [./thermal_constraint2]
    ...
    variable = thermal_lm1
    secondary_variable = li_ion_V
    secondary_boundary =  'interLayer_top'
    secondary_subdomain = 'mech_contact_sec_subdomain1'
    primary_boundary = 'blockMetal_bottom'
    primary_subdomain = 'mech_contact_primary_subdomain1'
    k = 1e-3
  ...
  [./thermal_constraint]
    ...
    primary_boundary = 'interLayer_bottom'
...
[BCs]
  ...
  [./left_right]
    type = ADDirichletBC
    variable = ux
    boundary = 'blockCeramic_left blockMetal_left blockCeramic_right interLayer_left'# blockMetal_right interLayer_left interLayer_right'
    value = 0
  [../]
  [./li_ion_bottom]
...
[VectorPostprocessors]
  [./interLayer_surface]
    ...
    sort_by = x
    boundary = 'interLayer_bottom'
    variable = 'bndliflux li_metal_conc uy'
  [../]
