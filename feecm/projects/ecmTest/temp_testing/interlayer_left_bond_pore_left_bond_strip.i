...
base_name = 'interlayer_left_bond_pore_right_bond_strip'
[Mesh]
  construct_node_list_from_side_list = true
  patch_update_strategy = iteration
  patch_size = 100
  file = check/interlayer_left_bond_pore_right_bond_cp/0155_mesh.cpr
  [./mesh]
...
[Problem]
  ...
  restart_file_base = check/interlayer_left_bond_pore_right_bond_cp/0155
  # coord_type = RZ
[]
...
[Functions]
  ...
  [./current_density]
    ...
    value = 'if (t <=10, ${current_density} - 2.0*${current_density}/10.0*t, -${current_density})'
  [../]
  [./reaction_rate_c]
