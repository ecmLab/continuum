...
[BCs]
  ...
  [constant_injection_flux]
    type = PorousFlowSink
    variable = tracer_concentration
    # flux_function = 'if (t <= 1e6,-1.0e-2, if (t <= 1.2e6, 0.0, 1e-2))'
...
[Materials]
  ...
  [permeability_aquifer]
    ...
    # block = aquifer
    permeability = '1E-14 0 0   0 1E-22 0   0 0 1E-22'
  []
  # [permeability_caps]
  #   type = PorousFlowPermeabilityConst
  #   block = caps
  ...
  [thermal_contribution]
    ...
    temperature = temperature
    thermal_expansion_coeff = 0.000 # this is the linear thermal expansion coefficient
