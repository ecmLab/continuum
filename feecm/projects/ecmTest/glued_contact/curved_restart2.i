[Mesh]
  ...
  file = check/curved3_cp/0480_mesh.cpr
  [./mesh]
...
[Functions]
  ...
  [./vel2]
    type = ParsedFunction
    value = 'if (t<=10, 0.002*exp(0.0001*t), 0.0)'
  [../]
  [./flux]
    type = ParsedFunction
...
[Problem]
  ...
  restart_file_base = check/curved3_cp/0480
[]
...
[Outputs]
  ...
  [./check]
    ...
    file_base = check/curved_restart2
    interval = 50
  [../]
[] # Outputs
