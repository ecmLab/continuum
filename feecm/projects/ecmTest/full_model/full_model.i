...
[Mesh]
  ...
  [./mesh]
    ...
    file = data/cosine_conformal.msh
  [../]
  [./symm]
    type = FileMeshGenerator
    file = data/cosine_conformal.msh
  ...
  [./rotate]
    ...
    input = symm
    transform = ROTATE
    vector_value = '0 180 180'
  [../]
  [./cmg]
    type = StitchedMeshGenerator
    inputs = 'mesh rotate'
    stitch_boundaries_pairs = 'blockCeramic_left blockCeramic_left
                              blockMetal_left blockMetal_left
                              interLayer_left interLayer_left'
...
[BCs]
  ...
  [./left_right]
    type = ADDirichletBC
    variable = ux
    boundary = 'blockCeramic_right blockMetal_right'
    value = 0
  [../]
  [./li_ion_bottom]
