...
[Problem]
  ...
  group_variables = 'ux uy; li_ion_V li_metal_conc mu_sigma'
...
[Functions]
  ...
  [./current]
    type = ParsedFunction
    value = 'if (t <=10, 1.2e-6*t, 1.2e-5)'
  [../]
  [./flux]
    type = ParsedFunction
    value = 'if (t <= 10, 1.24371375e-8*t, 1.24371375e-7)'
  [../]
  # [./current]
  #   type = ParsedFunction
  #   vars = 'voltage'
  #   vals = 'Voltage'
  #   value = 'if (voltage > 10, 1.2e-5)'
  # [../]
[]
...
[BCs]
  [./current]
    ...
    # current_density_function = current
