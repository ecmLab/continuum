...
[Variables]
  ...
  [./V_anode]
    # block = 'anode_s_block'
    block = 'anode_secondary_subdomain'
  [../]
  [./li_metal_conc]
    block = 'Cathode Anode'
  [../]
...
[Constraints]
  ...
  [./anode_constraint]
    ...
    secondary_subdomain = 'anode_secondary_subdomain'
    primary_boundary = 'Electrolyte_top'
    primary_subdomain = 'anode_primary_subdomain'
...
[Functions]
  ...
  [./current_density]
    type = ParsedFunction
    # value = 'if (t < 11, if(t < 1, 1e-6, 2e-3*(t-1)), 20e-3)'
    value = 'if (t<10, 2e-3*t, 20e-3 )'
  [../]
  [./anode_rct]
    type = ParsedFunction
    # value = 'if (x < 3900, 1e-3, if (x > 4200, 1e-3, 0))'
    value = 'if (t < 1e-5, if (x < 3900, 1e-3, if (x > 4200, 1e-3, 0)), 0.0)'
  [../]
[]
...
[BCs]
  ...
  [./x_disp]
    type = ADDirichletBC
    value = 0
    boundary = 'Cathode_left Electrolyte_left Anode_left'# Cathode_right Electrolyte_right Anode_right'
    variable = ux
    preset = true
  [../]
  [./y_disp]
    type = ADDirichletBC
    value = 0
    boundary = 'Cathode_bottom'# Electrolyte_bottom2'
    # boundary = 'Anode_top'
    variable = uy
    preset = true
  [../]
...
[Postprocessors]
  ...
  [./contact]
    ...
    variable = anode_normal_lm
    subdomain = anode_secondary_subdomain
  [../]
[]
...
[Problem]
  ...
  group_variables = 'ux uy normal_lm_x_cathode normal_lm_y_cathode anode_normal_lm; V V_anode V_cathode li_metal_conc'
