...
[Materials]
  ...
  [./diffusivity_Li_Cathode]
    type = ADGenericConstantMaterial
    prop_names = 'diffusivity_cath'
    block = 'Cathode'
    prop_values = '1e8'
  [../]
...
[Executioner]
  ...
  # scaling_group_variables = 'V V_cathode V_anode ux uy'
  scaling_group_variables = 'V V_cathode V_anode; ux uy; normal_lm_x_cathode normal_lm_y_cathode normal_lm_x_anode normal_lm_y_anode'
...
[Outputs]
  ...
  [./csv]
    type = CSV
    file_base = csv/testxxx
  [../]
  [./out]
    type = Exodus
    file_base = rst/testxxx
  [../]
[]
