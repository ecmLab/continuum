...
[Functions]
  ...
  [./anode_rct]
    type = ParsedFunction
    # value = 'if (x < 2000, ${k_anode}, if (x > 3000, ${k_anode}, 0))'
    value = 'if (x < 3000, ${k_anode},0.0)'
    # value = 'if (t < 1e-5, if (x < 3000, ${k_anode}, if (x > 4200, ${k_anode}, 0)), 0.0)'
  [../]
...
[Outputs]
  ...
  [./csv]
    type = CSV
    file_base = csv/rct_100_i_20.0_delam
  [../]
  [./out]
    type = Exodus
    file_base = rst/rct_100_i_20.0_delam
  [../]
[]
