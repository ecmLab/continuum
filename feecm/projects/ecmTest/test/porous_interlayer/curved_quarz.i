...
[Mesh]
  ...
  [./mesh]
    ...
    file = data/cosine_conformal_xx.msh
  [../]
  [./primary_block]
  ...
  [./top_node]
    ...
    top_right = '0.1 12.51 0'
    bottom_left = '-0.01 12.49 0'
...
[BCs]
  ...
  [./left_right]
    type = ADDirichletBC
    variable = ux
    boundary = 'blockCeramic_left blockMetal_left'# blockCeramic_right blockMetal_left blockMetal_right'
    value = 0
  [../]
  [./li_ion_bottom]
