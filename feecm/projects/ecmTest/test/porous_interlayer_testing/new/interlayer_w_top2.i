...
[Modules/TensorMechanics/Master]
  [./all]
    ...
    block = 'blockCeramic interLayer blockMetal blockPore blockTop'
...
[Contact]
  ...
  [./top_metal]
    formulation = mortar
    model = frictionless
    primary = 'blockTop_bottom'
    secondary = 'blockMetal_top'
    normal_smoothing_distance = 0.5
    tangential_tolerance = 0.25
  ...
  [./top_pore]
    ...
    model = frictionless
    primary = 'blockTop_bottom'
    secondary = 'blockPore_top'
    normal_smoothing_distance = 0.5
    tangential_tolerance = 0.25
    mesh = top_metal_secondary_subdomain_generator
  [../]
...
[Materials]
  ...
  [./elasticity_tensor_Li]
    ...
    poissons_ratio = 0.3
    block = 'interLayer blockMetal blockTop'
  [../]
  [./elasticity_tensor_C]
    type = ADComputeIsotropicElasticityTensor
...
[BCs]
  ...
  [./ux]
    type = ADDirichletBC
    preset = true
    boundary = 'blockCeramic_left blockCeramic_right interLayer_left blockMetal_left blockPore_right blockTop_left blockTop_right'
    variable = ux
    value = 0
  [../]
...
[Problem]
  ...
  group_variables = 'V flux_interlayer li_conc; ux uy  interlayer_ceramic_normal_lm metal_interlayer_normal_lm metal_pore_normal_lm interlayer_pore_normal_lm normal_lm_x_pore normal_lm_y_pore top_metal_normal_lm top_pore_normal_lm'
