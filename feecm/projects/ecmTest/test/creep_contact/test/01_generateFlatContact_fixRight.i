...
order = FIRST
strnRt = 0.0002
name = '01_generateFlatContact_fixRight'
...
[Mesh]
  ...
  [./blockSE_sidesets]
    ...
    new_boundary_name = 'blockSE_bottom blockSE_right blockSE_top blockSE_left'
  [../]
  [./blockSE_id]
...
#  [../]
  ...
  [./left_right]
    type = ADDirichletBC
    variable = disp_x
    boundary = 'blockLi_left blockLi_right blockSE_left blockSE_right blockSE_bottom'
    value = 0
    preset = true
  [../]
  [./bottom]
