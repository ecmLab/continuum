[Mesh]
  ...
  [./mesh]
    ...
    file = data/interlayer_ceramic2.e
  [../]
  [./primary_block]
...
[BCs]
  ...
  [./left_right]
    type = ADDirichletBC
    variable = ux
    boundary = 'blockCeramic_left blockMetal_left blockCeramic_right blockMetal_left blockMetal_right interLayer_left interLayer_right'
    value = 0
  [../]
  [./li_ion_bottom]
