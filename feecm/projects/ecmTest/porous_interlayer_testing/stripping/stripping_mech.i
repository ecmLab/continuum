...
[BCs]
  ...
  [./OV]
    type = ADDirichletBC
    boundary = 'interLayer_bottom blockPore_bottom'
    value = 0.0
    variable = V
  [../]
...
[Problem]
  ...
  group_variables = 'ux uy  interlayer_ceramic_normal_lm interlayer_pore_normal_lm normal_lm_x_pore normal_lm_y_pore; V flux_interlayer flux_pore li_conc'
