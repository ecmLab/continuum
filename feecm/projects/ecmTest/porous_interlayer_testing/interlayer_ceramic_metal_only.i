...
[Mesh]
  ...
  [./mesh]
    ...
    file = 'data/interlayer_ceramic_metal_only1.e'
...
[BCs]
  ...
  [./ux]
    type = ADDirichletBC
    preset = true
    boundary = 'blockCeramic_left blockCeramic_right interLayer_left interLayer_right blockMetal_left blockMetal_right'
    variable = ux
    value = 0
  [../]
...
[Problem]
  ...
  group_variables = 'V flux_interlayer li_conc; ux uy  normal_lm_x_anode normal_lm_y_anode metal_interlayer_normal_lm'
