...
[Problem]
  ...
  group_variables = 'V flux_interlayer li_conc flux_pore; ux uy normal_lm_x_anode normal_lm_y_anode normal_lm_x_pore normal_lm_y_pore interlayer_pore_normal_lm'
...
[Outputs]
  ...
  [./csv]
    type = CSV
    file_base = csv/test_pore_equil_w_c2
  [../]
  [./out]
    type = Exodus
    file_base = rst/test_pore_equil_w_c2
