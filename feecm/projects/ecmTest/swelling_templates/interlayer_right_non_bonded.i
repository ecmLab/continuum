...
base_name = 'interlayer_right_not_bonded'
[Mesh]
  ...
  [./mesh]
    ...
    file = 'data/interlayer_right_not_bonded.e'
  [../]
[]
[GlobalParams]
  displacements = 'ux uy'
...
[BCs]
  ...
  [./ux]
    type = ADDirichletBC
    preset = true
    boundary = 'blockCeramic_left blockCeramic_right interLayer_right'
    variable = ux
    value = 0
  [../]
...
[Problem]
  ...
  group_variables = 'ux uy interface_ceramic_nomral_lm; V flux_interlayer li_conc'
