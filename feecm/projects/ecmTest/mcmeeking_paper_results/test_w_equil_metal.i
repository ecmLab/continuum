...
[Mesh]
  ...
  [./mesh]
    ...
    file = 'data/test_w_pore_interlayer_metal_w_block.e'
  [../]
  #-------------------------------------------------------------#
...
[Contact]
  [./interlayer_pore]
    ...
    normal_smoothing_distance = 0.54
...
[BCs]
  ...
  [./pressure]
    type = ADPressure
    variable = uy
    boundary = 'blockMetal_top interLayer_top'
    component = 1
    function = pressure
  [../]
  # [./conc_top]
...
[Problem]
  ...
  group_variables = 'V flux_interlayer li_conc; ux uy normal_lm_x_anode normal_lm_y_anode normal_lm_x_pore normal_lm_y_pore interlayer_pore_normal_lm metal_interlayer_normal_lm metal_pore_normal_lm'
...
[Outputs]
  ...
  [./csv]
    type = CSV
    file_base = csv/test_pore_equil_w_metal
  [../]
  [./out]
    type = Exodus
    file_base = rst/test_pore_equil_w_metal
