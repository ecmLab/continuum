...
[Mesh]
  ...
  [subdomain_id]
    ...
    input = rename
    combinatorial_geometry = 'x >= 25 & x <= 50'
...
[Functions]
  ...
  [eq_pot_anode]
    type = PiecewiseLinear
    data_file = 'hard_carbon_equi_potential.csv'
    scale_factor = 1000.0
  []
[]
...
[Materials]
  ...
  [czm_elastic_incremental]
    ...
    boundary = 'Electrolyte_Cathode Anode_Electrolyte'
  ...
  [czm_var_jump]
    ...
    variable = V
    boundary = 'Anode_Electrolyte Electrolyte_Cathode'
  []
  [czm_global_traction]
