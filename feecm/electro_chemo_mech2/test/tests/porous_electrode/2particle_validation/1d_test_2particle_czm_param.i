...
cathode_solid_phase_diffusivity = 1e-13 #m^2/s
...
C_rate = 1.0
particle1_particle2_vol_fraction = 0.5
...
[Kernels]
  ...
  []
  [particle2_surface_concentration]
    type = SurfaceConcentration2ParameterAppox
    base_name = 'particle2'
...
[Materials]
  ...
  [particle1_Cathode_particle_size]
    ...
    volume_fraction = '${fparse total_volume_fraction * (1.0 - particle1_particle2_vol_fraction)}'
    block = Cathode
  []
  ...
  [particle2_Cathode_particle_size]
    ...
    particleType = SPHERICAL
    # particle_size = '${units 15.0 mum}'
    particle_size = ${particle2_size}
    volume_fraction = '${fparse total_volume_fraction * particle1_particle2_vol_fraction}'
    block = Cathode
  []
[]
...
[Outputs]
  ...
  csv = true
  # file_base = "xxxxx"
  # file_base = '${"w_" particle_1_particle2_vol_fraction}'
  [ex]
    type = Exodus
    file_base = '1d_ex'
...
[Controls]
  [start_c]
    ...
    disable_objects = 'Kernel::cs_time_parcticle1 Kernel::source_particle1_ave_c '
                      ...
                      'Kernel::cs_time_parcticle2 Kernel::source_particle2_ave_c '
                      'Kernel::particle2_surface_concentration'
    start_time = '0'
    end_time = '0.01'
  []
[]
