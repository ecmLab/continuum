...
registerADMooseObject("electro_chemo_mechApp", ADIsoTropicHyperViscoSwellingCreep);
...
//
//ADReal
//ADIsoTropicHyperViscoSwelling::maximumPermissibleValue(
...
//template <>
//DualReal
//ADIsoTropicHyperViscoSwellingCreep<JACOBIAN>::computeHardeningValue(const DualReal & scalar)
//{
//    DualReal ssat;
//    if (scalar > 0)
//        ssat = _shear_saturation * std::pow(scalar/_shear_rate , _n);
