...
#include "ADIsoTropicHyperVisco.h"

#include "ElasticityTensorTools.h"

registerADMooseObject("electro_chemo_mechApp", ADIsoTropicHyperVisco);

InputParameters
ADIsoTropicHyperVisco::validParams()
{
...
ADIsoTropicHyperVisco::ADIsoTropicHyperVisco(const InputParameters & parameters)
...
void
ADIsoTropicHyperVisco::initQpStatefulProperties()
{
...
void
ADIsoTropicHyperVisco::propagateQpStatefulProperties()
{
...
void
ADIsoTropicHyperVisco::computeStressInitialize(
...
void
ADIsoTropicHyperVisco::iterationFinalize(ADReal scalar)
{
    if (scalar >= 0.0)
...
ADReal
ADIsoTropicHyperVisco::computeResidual(
...
ADReal
ADIsoTropicHyperVisco::computeDerivative(
    const ADReal & /*effective_trial_stress*/, const ADReal & scalar)
{
...
void
ADIsoTropicHyperVisco::computeStressFinalize(const ADRankTwoTensor & plastic_strain_increment)
{
...
ADReal
ADIsoTropicHyperVisco::computeHardeningValue(const ADReal & scalar)
{
...
//template <>
//DualReal
//ADIsoTropicHyperVisco<JACOBIAN>::computeHardeningValue(const DualReal & scalar)
//{
//    return _strength_variable_old[_qp] + _dt * _hardening_variable[_qp] * scalar;
//}
...
ADReal
ADIsoTropicHyperVisco::computeHardeningDerivative(const ADReal & /*scalar*/)
{
...
Real
ADIsoTropicHyperVisco:: computeTimeStepLimit()
{
