...
#include "ADIsoTropicHyperViscoCreep.h"

#include "ElasticityTensorTools.h"

registerADMooseObject("electro_chemo_mechApp", ADIsoTropicHyperViscoCreep);

InputParameters
ADIsoTropicHyperViscoCreep::validParams()
{
	InputParameters params = ADIsoTropicHyperViscoBase::validParams();
...
ADIsoTropicHyperViscoCreep::ADIsoTropicHyperViscoCreep(const InputParameters & parameters)
  : ADIsoTropicHyperViscoBase(parameters),
...
//
//ADReal
//ADIsoTropicHyperVisco::maximumPermissibleValue(
...
void
ADIsoTropicHyperViscoCreep::initQpStatefulProperties()
{
...
void
ADIsoTropicHyperViscoCreep::propagateQpStatefulProperties()
{
...
void
ADIsoTropicHyperViscoCreep::computeStressInitialize(
...
void
ADIsoTropicHyperViscoCreep::iterationFinalize(ADReal scalar)
{
    if (scalar >= 0.0)
...
ADReal
ADIsoTropicHyperViscoCreep::computeResidual(
...
ADReal
ADIsoTropicHyperViscoCreep::computeDerivative(
    const ADReal & /*effective_trial_stress*/, const ADReal & scalar)
{
...
void
ADIsoTropicHyperViscoCreep::computeStressFinalize(
...
ADReal
ADIsoTropicHyperViscoCreep::computeHardeningValue(const ADReal & scalar)
{
    ADReal ssat;
    if (scalar > 0)
...
//template <>
//DualReal
//ADIsoTropicHyperViscoCreep<JACOBIAN>::computeHardeningValue(const DualReal & scalar)
//{
//    DualReal ssat;
//    if (scalar > 0)
//        ssat = _shear_saturation * std::pow(scalar/_shear_rate , _n);
...
//    _saturation_strength[_qp] = ssat;
//    _hardening_variable[_qp] = _shear_initial_hardness
//                        * std::pow(std::abs(temp), _ahard) * sgn(temp);
//    return _strength_variable_old[_qp] + _dt * _hardening_variable[_qp] * scalar;
//}


ADReal
ADIsoTropicHyperViscoCreep::computeHardeningDerivative(const ADReal & /*scalar*/)
{
...
Real
ADIsoTropicHyperViscoCreep:: computeTimeStepLimit()
{
