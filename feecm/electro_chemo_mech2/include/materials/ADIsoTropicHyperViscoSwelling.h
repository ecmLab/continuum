...
class ADIsoTropicHyperViscoSwelling;
...
class ADIsoTropicHyperViscoSwelling : public ADIsoTropicHyperViscoSwellingBase
{
public:
	static InputParameters validParams();
    ADIsoTropicHyperViscoSwelling(const InputParameters & parameters);
