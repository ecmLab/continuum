...
[Mesh]
  ...
  [./mesh]
    ...
    file = 'data/interlayer_expand2.e'
...
[Functions]
  ...
  [./li_metal_flux]
    type = ParsedFunction
    value = 'if (t <=10, if (t <= 1, 0, ${metal_flux}/9.0*(t-1)), ${metal_flux})'
...
[Problem]
  ...
  group_variables = 'ux uy  interlayer_ceramic_normal_lm metal_interlayer_normal_lm metal_pore_normal_lm interlayer_pore_normal_lm normal_lm_x_pore normal_lm_y_pore li_conc'
...
[Outputs]
  ...
  [./csv]
    type = CSV
    file_base = csv/expand
  [../]
  [./out]
    type = Exodus
    file_base = rst/expand
