...
[Mesh]
  ...
  [./mesh]
    ...
    file = 'data/interlayer_ceramic_metal_pore.e'
    # file = 'data/test_w_pore_interlayer_w_block_metal_h0.5.e'
...
[Problem]
  ...
  group_variables = 'V flux_interlayer li_conc; ux uy  interlayer_ceramic_normal_lm metal_interlayer_normal_lm metal_pore_normal_lm interlayer_pore_normal_lm pore_ceramic_normal_lm'
...
[Outputs]
  ...
  [./csv]
    type = CSV
    file_base = csv/test_pore_equil_rest2
  [../]
  [./out]
    type = Exodus
    file_base = rst/test_pore_equil_rest2
    execute_on = 'INITIAL TIMESTEP_END'
    interval = 2
  [../]
  [./check]
    type = Checkpoint
    file_base = test_pore_equil2
    start_time = 60.0
    interval = 5
    num_files = 4
  [../]
