...
[Mesh]
  ...
  patch_size = 100
  # file = check/pore_cp/0002_mesh.cpr
  [./mesh]
...
[Materials]
  ...
  [../]
  # [./stress_Li]
  #   type = ADComputeMultipleInelasticStress7
...
[BCs]
  ...
  [./ux]
    type = ADDirichletBC
    preset = true
    boundary = 'blockCeramic_left blockCeramic_right blockPore_right'
    variable = ux
    value = 0
  [../]
...
[Executioner]
  ...
  # num_steps = 1
  end_time = ${end_time}
  scaling_group_variables = 'V flux_pore'
...
[Problem]
  ...
  group_variables = 'ux uy normal_lm_x_pore normal_lm_y_pore; V flux_pore li_conc'
  acceptable_iterations = 2
  # restart_file_base = check/pore_cp/0002
  # coord_type = RZ
[]
[Outputs]
  # csv = true
  ...
  [./csv]
    type = CSV
    file_base = csv/just_pore
  [../]
  [./out]
    type = Exodus
    file_base = rst/just_pore
