...
base_name = 'interlayer_full_non_bonded'
[Mesh]
...
[Problem]
  ...
  group_variables = 'ux uy interface_ceramic_normal_lm; V flux_interlayer li_conc'
...
[Functions]
  ...
  [./current_density]
    ...
    value = 'if (t <=10, ${current_density}/10.0*t, if (t <=30, ${current_density}, if (t<=40, ${current_density}- 2.0*${current_density}*(t-30)/10.0,-${current_density}) ))'
  [../]
  [./reaction_rate_c]
