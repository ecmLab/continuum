...
#  [../]
  ...
  [./left_right]
    type = ADDirichletBC
    variable = disp_x
    boundary = 'blockMetal_left blockMetal_right blockCeramic_left blockCeramic_right blockCeramic_bottom'
    value = 0
    preset = true
  [../]
  [./bottom]
...
[Postprocessors]
 ...
 [./contact]
    ...
    variable = mechContact_normal_lm
    subdomain = mechContact_secondary_subdomain
  [../]
[]
