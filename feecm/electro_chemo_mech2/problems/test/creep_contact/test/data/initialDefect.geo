...
//+
Physical Curve("Ceramic_bottom") = {bSEl-2};
//+
Physical Curve("Ceramic_right") = {bSEl-1};
//+
Physical Curve("Ceramic_left") = {eSEl};
//+
Physical Curve("Ceramic_top") = {bSEl:eSEl-1};
//+
Physical Curve("Li_metal_top") = {bLil};
//+
Physical Curve("Li_metal_left") = {bLil+1};
//+
Physical Curve("Li_metal_bottom") = {bLil+2}; 
//+
Physical Curve("Li_metal_right") = {bLil+3};
//+
Physical Surface("Ceramic") = {1};
//+
Physical Surface("Li_metal") = {2};
//+
