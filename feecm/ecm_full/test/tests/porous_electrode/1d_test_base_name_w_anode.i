...
[Problem]
  ...
  # group_variables = 'phi_s ph_e ave_c'
...
[Kernels]
  ...
  [source_electrolyte]
    ...
    base_name = 'Cathode'
    materials = 'Cathode_bulter_volmer_material'
    variable = phi_e
    scale = -1.0
...
[Materials]
  ...
  [solid_phase_diff]
    ...
    block = 'Cathode'
  []
  [Cathode_bulter_volmer_material]
...
[BCs]
  ...
  [current]
    type = FunctionNeumannBC
    variable = phi_s
    # function = 'if (t >0.005 ,if (t < 1.005, -2.4e-1*(t-0.005), -2.4e-1), 0.0)'
    function = '-2.4e-1'
...
[Postprocessors]
  [max_soc]
    ...
    mat_prop = "Cathode_state_of_charge"
    block = Cathode
    value_type = max
  []
  [Cell_voltage]
...
[Executioner]
  ...
  # scaling_group_variables = 'phi_s phi_e ave_c'
