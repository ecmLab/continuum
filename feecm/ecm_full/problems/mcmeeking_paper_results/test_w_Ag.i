...
[Mesh]
  ...
  [../]
  #-------------------------------------------------------------#
  # # --- interface between pore wall and Ag
  # [./pore_Ag_secondary]
  #   type = LowerDBlockFromSidesetGenerator
...
[Modules/TensorMechanics/Master]
  [./all]
    ...
    block = 'blockCeramic interLayer blockPore blockSilver '
...
[Contact]
  [./interlayer_pore]
    ...
    mesh = interLayer_Ag_primary
  [../]
  [./pore_Ag]
    formulation = mortar
    model = frictionless
    primary = 'blockSilver_top'
...
[Variables]
  ...
  # Li metal flux at pore Ag boundary
  [./flux_pore_Ag]
    block = 'pore_Ag_secondary_subdomain'
  [../]
  ...
  [./li_conc]
    block = 'interLayer blockSilver blockPore'
  [../]
  [./normal_lm_x_Ag]
    block = 'Ag_s_block'
  [../]
...
[AuxVariables]
  ...
  [./eq_pot]
    ...
    family = MONOMIAL
  [../]
  [./interface_normal_stress]
    order = CONSTANT
    family = MONOMIAL
  [../]
  [./interface_normal_growth_stress]
    order = CONSTANT
    family = MONOMIAL
  [../]
  [./soc]
...
[AuxKernels]
  ...
  [./li_ion_flux_x]
    ...
    diffusion_variable = V
    diffusivity = thermal_conductivity
    block = 'blockCeramic blockPore interLayer blockSilver'
  [../]
  ...
  [./eq_pot]
    ...
    variable = eq_pot
    block = 'interLayer blockPore blockSilver'
  ...
  [../]
  [./interface_normal_Stress]
    type = ADRankTwoTensorNormalToBoundary
    variable = interface_normal_stress
    tensor = stress
    boundary = 'interLayer_bottom'
  [../]
  [./interface_normal_growth_stress]
    type = ADRankTwoTensorNormalToBoundary
    variable = interface_normal_growth_stress
    tensor = growth_stress
    boundary = 'interLayer_bottom'
  [../]
...
[Constraints]
  ...
  [./equilibriate_pore]
    ...
    secondary_subdomain = 'pore_Ag_secondary_subdomain'
    primary_boundary = 'blockSilver_top'
    primary_subdomain = 'pore_Ag_primary_subdomain'
    extra_vector_tags = 'ref'
    prefactor = RT
    # one_sided = SECONDARY->PRIMARY
  [../]
...
[Materials]
  [./thermal_conductivity1]
    ...
    block = 'blockPore blockSilver interLayer'
  [../]
...
[BCs]
  ...
  [./ux]
    type = ADDirichletBC
    preset = true
    boundary = 'blockCeramic_left blockCeramic_right interLayer_left blockPore_right blockSilver_left blockSilver_right'
    variable = ux
    value = 0
  [../]
