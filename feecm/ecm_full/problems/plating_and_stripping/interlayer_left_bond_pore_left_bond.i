...
k_interLayer = 1e-3
c_init_interLayer = 0.1
# c_init_C = 2.592e-2
c_init_blockPore = 2.5925e-2
c_max_C = 3.05e-2
c_ref_blockPore = 2.5925e-2
pressure = 5e-1
end_time = 500
metal_flux = 2.0534e-3
base_name = 'interlayer_left_bond_pore_right_bond_ag_c_plating'
[Mesh]
  construct_node_list_from_side_list = true
  patch_update_strategy = iteration
  patch_size = 100
  file = check/interlayer_left_bond_pore_right_bond_mech_cp/0004_mesh.cpr
  [./mesh]
    type = FileMeshGenerator
    file = 'data/interlayer_left_pore_right_fine.e'
  [../]
...
[Problem]
  ...
  group_variables = 'ux uy normal_lm_x_interLayer normal_lm_y_interLayer normal_lm_x_blockPore normal_lm_y_blockPore interLayer_blockPore_normal_lm; V flux_interlayer flux_blockPore li_conc'
  acceptable_iterations = 2
  restart_file_base = check/interlayer_left_bond_pore_right_bond_mech_cp/0004
  # coord_type = RZ
[]
