...
Point(1) = {0, 0, 0, 20.0};
//+
Point(2) = {l_cathode, 0, 0, 10};
//+
Point(3) = {0, -y_cathode, 0, 40};
//+
Point(4) = {l_cathode, -y_cathode, 0, 40};
//+
Line(1) = {1, 2};
//+
Line(2) = {2, 4};
...
//+
Point(10) = {0,y_electrolyte, 0, 40};
//+
Point(11) = {l_anode,y_electrolyte, 0, 40};
//+
Point(12) = {l_anode,y_electrolyte + y_anode, 0, 40};
//+
Point(13) = {0,y_electrolyte + y_anode, 0, 40};
//+
Line(10) = {10, 11};
//+
