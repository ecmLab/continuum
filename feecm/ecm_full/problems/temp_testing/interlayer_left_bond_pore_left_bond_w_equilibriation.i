...
# c_init_C = 2.592e-2
c_init_blockPore = 2.5925e-2
c_max_C = 3.05e-2
c_ref_blockPore = 0.0
pressure = 5e-1
end_time = 500
metal_flux = 2.0534e-3
base_name = 'interlayer_left_bond_pore_right_bond'
[Mesh]
  construct_node_list_from_side_list = true
  patch_update_strategy = iteration
  patch_size = 100
  file = check/interlayer_left_bond_pore_right_bond_mech_cp/0015_mesh.cpr
  [./mesh]
...
[Variables]
  ...
  # --- equilibriate normal flux between pore adn interlayer
  [./pore_interlayer_flux_lm]
    block = 'interLayer_blockPore_secondary_subdomain'
  [../]
[]
...
[Contact]
  [./interLayer_blockPore]
    ...
    mesh = blockPore_ceramic_primary
  [../]
[]
...
[Constraints]
  ...
  [./blockPore_V_constraint]
    type = GapDisplacementConductanceConstraint
    variable = flux_blockPore
    secondary_variable = V
  ...
  [./blockPore_mech_y]
    ...
    use_displaced_mesh = true
  [../]
 #--- Allow flux between pore and interlayer
 [./pore_interayer_flux]
   type = EqualNormalFluxConstraint
   primary_boundary = 'blockPore_left'
   primary_subdomain = 'interLayer_blockPore_primary_subdomain'
   secondary_boundary = 'interLayer_right'
   secondary_subdomain = 'interLayer_blockPore_secondary_subdomain'
   primary_mat_prop = 'diff_blockPore'
   primary_tensor = false
   secondary_mat_prop = diffusivity
   secondary_tensor = true
   primary_variable = li_conc
   secondary_variable = li_conc
   variable = pore_interlayer_flux_lm
 [../]
[]
...
[Materials]
  ...
  [./diff_in_interLayer]
    ...
    diffusivity_vector = '5e8 0.5 0.5'
    block = 'interLayer'
  [../]
  [./diff_in_blockPore]
...
[BCs]
  ...
  [./OV]
    type = ADDirichletBC
    value = 0.0
    boundary = 'interLayer_top blockPore_top'
    variable = V
  [../]
...
[Problem]
  ...
  group_variables = 'ux uy normal_lm_x_interLayer normal_lm_y_interLayer normal_lm_x_blockPore normal_lm_y_blockPore interLayer_blockPore_normal_lm; V flux_interlayer flux_blockPore li_conc pore_interlayer_flux_lm'
  acceptable_iterations = 2
  restart_file_base = check/interlayer_left_bond_pore_right_bond_mech_cp/0015
  # coord_type = RZ
[]
...
[Outputs]
  ...
  [./out]
    ...
    sync_times = '1.0 ${ramp_time} ${end_time}'
    sync_only = false
    # interval = 1
  [../]
  [./check]
...
[Functions]
  ...
  [./current_density]
    ...
    value = 'if (t <=${ramp_time}, ${current_density}/${ramp_time}*t, ${current_density})'
  [../]
  [./reaction_rate_c]
  ...
  [./reaction_rate_ag]
    type = ParsedFunction
    value = 'if (t > 1.0, 0, 200.0 -200.0*t)'
  [../]
