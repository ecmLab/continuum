...
[Mesh]
  ...
  patch_size = 100
  # file = check/pore_mech_cp/0035_mesh.cpr
  [./mesh]
...
[Contact]
  ...
  [./interlayer_pore]
    ...
    mesh = interlayer_ceramic_primary
  [../]
...
[Functions]
  ...
  [./current_density]
    ...
    value = 'if (t <=10, if (t <= 1, 0, ${current_density}/9.0*(t-1)), ${current_density})'
  [../]
  [./reaction_rate_c]
...
[BCs]
  ...
  [./ux]
    type = ADDirichletBC
    preset = true
    boundary = 'blockCeramic_left blockCeramic_right blockPore_right interLayer_left'
    variable = ux
    value = 0
  [../]
...
[Executioner]
  ...
  end_time = 100
  # end_time = ${end_time}
  # scaling_group_variables = 'V flux_pore flux_interlayer'
...
[Problem]
  ...
  group_variables = 'ux uy normal_lm_x_pore normal_lm_y_pore interlayer_pore_normal_lm normal_lm_x_interlayer normal_lm_y_interlayer'#; V flux_pore flux_interlayer li_conc'
  acceptable_iterations = 2
  # restart_file_base = check/pore_mech_cp/0035
  # coord_type = RZ
[]
[Outputs]
  # csv = true
  ...
  [./csv]
    type = CSV
    file_base = csv/pre_mech
  [../]
  [./out]
    type = Exodus
    file_base = rst/pore_mech
