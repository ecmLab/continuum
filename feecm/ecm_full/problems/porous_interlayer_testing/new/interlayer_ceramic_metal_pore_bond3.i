...
[Mesh]
  ...
  [./mesh]
    ...
    file = 'data/test_w_pore_interlayer_w_block_metal_h0.1_shallow4.e'
...
[Problem]
  ...
  group_variables = 'V flux_interlayer li_conc; ux uy  interlayer_ceramic_normal_lm metal_pore_normal_lm normal_lm_x_pore normal_lm_y_pore'
...
[Outputs]
  ...
  [./csv]
    type = CSV
    file_base = csv/pore2_1mA
  [../]
  [./out]
    type = Exodus
    file_base = rst/pore2_1mA
