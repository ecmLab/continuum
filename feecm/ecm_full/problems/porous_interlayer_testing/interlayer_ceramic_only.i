...
[Mesh]
  ...
  [./mesh]
    ...
    file = 'data/interlayer_ceramic_only.e'
...
[BCs]
  ...
  [./ux]
    type = ADDirichletBC
    preset = true
    boundary = 'blockCeramic_left blockCeramic_right interLayer_left interLayer_right'
    variable = ux
    value = 0
  [../]
  ...
  [./uy]
    type = ADDirichletBC
    preset = true
    boundary = 'blockCeramic_bottom interLayer_top'
    variable = uy
    value = 0
  [../]
  # [./pressure]
...
[Problem]
  ...
  group_variables = 'V flux_interlayer li_conc; ux uy normal_lm_y_anode normal_lm_x_anode'
