...
dt = '${fparse t0/50}'      # Inital time step, to be adapted in TimeStepper, in s
...
beta_a = 0.1  # Swelling coefficient of Na15Sn4, dimensionless
beta_e = 0.05  # Swelling coefficient of SE, dimensionless
...
D_a = 5e-8   # Na diffusivity in Na15Sn4 is 1.4e-8 mm^2/s
...
[Functions]
 [in]
   ...
   x = '0  ${dt}  ${t0}'  # Time points: start, ramp_end, simulation_end
