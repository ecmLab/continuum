...
% Ag_dia = generateAg([Lx, Hx],[0.011, Ag_Mden, 10, 0.04, 0.001, 0.03, 0.05],0);         % The diameter of Ag particles, in unit um        
Ag_dia = generateAg([Lx, Hx],[0.03, Ag_Mden, 10, 0.04, 0.001, 0.038, 0.042],0);         % The diameter of Ag particles, in unit um   
